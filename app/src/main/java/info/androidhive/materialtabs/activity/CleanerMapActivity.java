...
/**
 * Created by KBPark on 2016. 12. 4..
 */
 ...
 *  해야할 것
 *  1. DB에 data 원하는걸로 넣기
 *  2. DB name, table 조정하는거 알아보기!
 *  3.
 *
 *  Service 어디에 쓸지 고민
 *  Broadcast Receiver 완성!
 *
 *  리포트 내용 정리가 먼저 되야하고,
 *  그걸 토대로 발표 정리!
 *
...
public class CleanerMapActivity extends AppCompatActivity
{
    @Override
    public void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cleaner_googlemap);
        ...
        ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map)).getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                // 임시값 : 원희형네 집 장성동집
                double latitude = 36.0826939;
                double longitude = 129.39147379999997;
