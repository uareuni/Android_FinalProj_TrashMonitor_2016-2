...
import info.androidhive.materialtabs.activity.UserActivity;
...
public class AddUsingContentProvider implements EventAdder {
    ...
    public void addEvent(Context ctx, String title, Calendar start, Calendar end) {
        ...
        calEvent.put(CalendarContract.Events.EVENT_TIMEZONE, "Asia/Seoul");
        ...
        Toast.makeText(ctx, "You have uploaded your data to Google calendar. No:" + id, Toast.LENGTH_SHORT).show();
    }
